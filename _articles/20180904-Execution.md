...
date: 04.09.2018
ReadMore: Watch
subtext: In this tutorial, Mihai demonstrates how to execute INTACT Webtest test cases, including an Internet of Things platform that checks a thermostat's temperature. The video also provides examples of how to use Context Objects.
